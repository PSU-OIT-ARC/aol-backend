...
ALLOWED_HOSTS = ["aol-backend.stage.wdt.pdx.edu"]
...
STATIC_ROOT = "/vol/www/aol-backend/static/stage"
MEDIA_ROOT = "/vol/www/aol-backend/media/stage"

DATABASES['default']['HOST'] = 'aol-backend-stage.c6xuiyamhpsi.us-west-2.rds.amazonaws.com'
